...
describe('Blockchain', () => {
    let blockchain, errorMock, newChain, originalChain;
    ...
    describe('isValidChain()', () => {
        ...
        describe('when the chain starts with the genesis block and has multipole blocks', () => {
            ...
            describe('the chain doesn not contain any invalid fields', () => {
                it('returns true', () => {
